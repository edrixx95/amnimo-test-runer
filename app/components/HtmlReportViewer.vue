<template>
  <Transition name="modal">
    <div v-if="modelValue" class="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div class="modal-content relative bg-white rounded-2xl shadow-glass w-full max-w-7xl h-[95vh] flex flex-col overflow-hidden">
        ...
        <div class="px-8 py-5 border-b border-slate-100 flex justify-between items-center bg-white shrink-0">
          ...
          <div class="flex items-center gap-3">
            <a :href="url" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-bold text-slate-700 bg-slate-50 border border-slate-200 rounded-xl hover:bg-white hover:text-amnimo-600 hover:border-amnimo-200 transition-all shadow-sm active:scale-95">
        ...
        <div class="flex-1 overflow-hidden bg-slate-50 relative">
          <div v-if="isLoading" class="absolute inset-0 flex flex-col items-center justify-center bg-slate-50 z-10 gap-4">
